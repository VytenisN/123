<div class="site-header">
    <table class="mx-auto w-100">
        <tr>
            <td><img class="site-logo" src="images/auto-nuoma.png" alt="Automobilių nuomos internetinė informacinė sistema | UAB Auto 7/24"></td>
            <td>
                <h1 class="site-title">Automobilių nuoma 24/7</h1>
               <div class="row site-header-top-grid">
                        <div class="col p-0"><button class="btn m-0 p-0 pb-1 pl-2 pr-2"><i class="fa fa-phone pr-1" aria-hidden="true"></i>+370 699 99999</button></div>
                        ...
                        <div class="col p-0 pl-1"><a href="https://plus.google.com/"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></div>
                </div>
            </td>
        </tr>
    </table>
